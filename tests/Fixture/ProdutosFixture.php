...
class ProdutosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'unidade_medida' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'data_validade' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'data_fabricacao' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'preco' => 1.5,
                'produto_perecivel' => 1,
                'data_validade' => '2023-05-10 01:15:18',
                'data_fabricacao' => '2023-05-10 01:15:18',
            ],
        ];
        parent::init();
    }
